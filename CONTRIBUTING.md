...
The following is a set of guidelines for contributing to the `R` package `hySpc.read.jdx`.

## Code Licensing

By contributing, you understand and agree that your work becomes the part of the `hySpc.read.jdx` project and will be licensed under the [GNU GPL v3](https://github.com/r-hyperspec/hySpc.read.jdx/blob/master/LICENSE).

## Reporting Bugs and Submitting Suggestions

* Ensure the bug was not already reported by searching on GitHub under [Issues](https://github.com/r-hyperspec/hySpc.read.jdx/issues).
...
* When parts of the `hySpc.read.jdx` objects are mentioned, use the syntax formatting, for instance `@data`{.r}.
...
* If you need to leave a note in a vignette, please use this [method](https://github.com/cbeleites/hySpc.read.jdx/pull/147#issuecomment-646685392).
